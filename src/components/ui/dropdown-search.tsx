...
const DropdownSearch: React.FC<DropdownSearchProps> = ({ className, isActive, children }) => {
  return (
    <div
      className={cn(
        'invisible absolute top-[125%] left-0 z-20 flex max-h-[400px] w-full -translate-x-1 -translate-y-1 flex-col overflow-auto rounded-md bg-white py-2 opacity-0 transition-[translate,opacity]',
